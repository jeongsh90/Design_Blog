# 제목: 바른히피 무료 한글 웹폰트 — 힙한 필치의 바른 손글씨체

- 카테고리: Design > Font
- 태그: 바른히피, 무료폰트, 한글폰트, 손글씨체, 웹폰트
- 메타디스크립션: 네이버이 배포하는 무료 한글 폰트 바른히피를 실제 페이지 기준으로 검증해 라이선스와 웹폰트 코드까지 정리했습니다.
...
## 검증 기록
- 1차 출처: noonnu.cc 바른히피 페이지(font_page/514)
- 확인 시점: 2026-09-10
