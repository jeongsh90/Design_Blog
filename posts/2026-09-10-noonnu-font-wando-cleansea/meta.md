# 제목: 완도청정바다체 무료 한글 웹폰트 — 다도해의 섬을 닮은 완도 본문용 서체

- 카테고리: Design > Font
- 태그: 완도청정바다체, 무료폰트, 한글폰트, 고딕체, 웹폰트
- 메타디스크립션: 완도군이 배포하는 무료 한글 폰트 완도청정바다체를 실제 페이지 기준으로 검증해 라이선스와 웹폰트 코드까지 정리했습니다.
...
## 검증 기록
- 1차 출처: noonnu.cc 완도청정바다체 페이지(font_page/470)
- 확인 시점: 2026-09-10
