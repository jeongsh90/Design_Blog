# 제목: 코트라 볼드체 무료 한글 웹폰트 — 곧고 굵은 코트라 제목용 고딕체

- 카테고리: Design > Font
- 태그: 코트라볼드체, 무료폰트, 한글폰트, 고딕체, 웹폰트
- 메타디스크립션: Kotra이 배포하는 무료 한글 폰트 코트라 볼드체를 실제 페이지 기준으로 검증해 라이선스와 웹폰트 코드까지 정리했습니다.
...
## 검증 기록
- 1차 출처: noonnu.cc 코트라 볼드체 페이지(font_page/485)
- 확인 시점: 2026-09-10
