# 제목: 카페24 단정해 무료 한글 웹폰트 — 장식이 돋보이는 클래식한 제목용 서체

- 카테고리: Design > Font
- 태그: 카페24단정해, 무료폰트, 한글폰트, 장식체, 웹폰트
- 메타디스크립션: Cafe24이 배포하는 무료 한글 폰트 카페24 단정해를 실제 페이지 기준으로 검증해 라이선스와 웹폰트 코드까지 정리했습니다.
...
## 검증 기록
- 1차 출처: noonnu.cc 카페24 단정해 페이지(font_page/340)
- 확인 시점: 2026-09-10
