# 제목: 빙그레 싸만코체 무료 한글 웹폰트 — 붕어빵처럼 통통한 아이스크림 브랜드 서체

- 카테고리: Design > Font
- 태그: 빙그레싸만코체, 무료폰트, 한글폰트, 장식체, 웹폰트
- 메타디스크립션: 빙그레이 배포하는 무료 한글 폰트 빙그레 싸만코체를 실제 페이지 기준으로 검증해 라이선스와 웹폰트 코드까지 정리했습니다.
...
## 검증 기록
- 1차 출처: noonnu.cc 빙그레 싸만코체 페이지(font_page/461)
- 확인 시점: 2026-09-10
