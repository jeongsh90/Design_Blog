# 제목: 을지로10년후체 무료 한글 웹폰트 — 을지로의 세월을 담은 배달의민족 서체

- 카테고리: Design > Font
- 태그: 을지로10년후체, 무료폰트, 한글폰트, 고딕체, 웹폰트
- 메타디스크립션: 우아한형제들이 배포하는 무료 한글 폰트 을지로10년후체를 실제 페이지 기준으로 검증해 라이선스와 웹폰트 코드까지 정리했습니다.
...
## 검증 기록
- 1차 출처: noonnu.cc 을지로10년후체 페이지(font_page/499)
- 확인 시점: 2026-09-10
