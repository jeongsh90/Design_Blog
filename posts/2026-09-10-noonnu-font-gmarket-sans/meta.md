# 제목: G마켓 산스 무료 한글 웹폰트 — 브랜드 아이덴티티를 담은 산스 고딕체

- 카테고리: Design > Font
- 태그: G마켓산스, 무료폰트, 한글폰트, 고딕체, 웹폰트
- 메타디스크립션: G마켓이 배포하는 무료 한글 폰트 G마켓 산스를 실제 페이지 기준으로 검증해 라이선스와 웹폰트 코드까지 정리했습니다.
...
## 검증 기록
- 1차 출처: noonnu.cc G마켓 산스 페이지(font_page/366)
- 확인 시점: 2026-09-10
