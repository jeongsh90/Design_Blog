# 제목: 모노플렉스WideNerd 무료 한글 웹폰트 — 모노플렉스WideNerd의 결을 담은 무료 한글 서체

- 카테고리: Design > Font
- 태그: 모노플렉스WideNerd, 무료폰트, 한글폰트, 고딕체, 웹폰트
- 메타디스크립션: 김양수이 배포하는 무료 한글 폰트 모노플렉스WideNerd를 실제 페이지 기준으로 검증해 라이선스와 웹폰트 코드까지 정리했습니다.
...
## 검증 기록
- 1차 출처: font_page/1013 (모노플렉스WideNerd)
- 확인 시점: 2026-09-10
