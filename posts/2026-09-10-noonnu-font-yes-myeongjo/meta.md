# 제목: 예스 명조 무료 한글 웹폰트 — 출판 본문에 맞는 예스24 명조체

- 카테고리: Design > Font
- 태그: 예스명조, 무료폰트, 한글폰트, 명조체, 웹폰트
- 메타디스크립션: 예스24이 배포하는 무료 한글 폰트 예스 명조를 실제 페이지 기준으로 검증해 라이선스와 웹폰트 코드까지 정리했습니다.
...
## 검증 기록
- 1차 출처: noonnu.cc 예스 명조 페이지(font_page/406)
- 확인 시점: 2026-09-10
