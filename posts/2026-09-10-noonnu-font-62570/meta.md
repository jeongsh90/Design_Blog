# 제목: 62570체 무료 한글 웹폰트 — 6·25 70주년을 기념하는 보훈 서체

- 카테고리: Design > Font
- 태그: 62570체, 무료폰트, 한글폰트, 명조체, 웹폰트
- 메타디스크립션: 국가보훈처 X 투게더그룹이 배포하는 무료 한글 폰트 62570체를 실제 페이지 기준으로 검증해 라이선스와 웹폰트 코드까지 정리했습니다.
...
## 검증 기록
- 1차 출처: noonnu.cc 62570체 페이지(font_page/440)
- 확인 시점: 2026-09-10
