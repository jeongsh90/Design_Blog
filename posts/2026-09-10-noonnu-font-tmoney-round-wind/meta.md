# 제목: 티머니 둥근바람 무료 한글 웹폰트 — 둥근 바람처럼 부드러운 티머니 고딕체

- 카테고리: Design > Font
- 태그: 티머니둥근바람, 무료폰트, 한글폰트, 고딕체, 웹폰트
- 메타디스크립션: 티머니 X 윤디자인이 배포하는 무료 한글 폰트 티머니 둥근바람를 실제 페이지 기준으로 검증해 라이선스와 웹폰트 코드까지 정리했습니다.
...
## 검증 기록
- 1차 출처: noonnu.cc 티머니 둥근바람 페이지(font_page/458)
- 확인 시점: 2026-09-10
