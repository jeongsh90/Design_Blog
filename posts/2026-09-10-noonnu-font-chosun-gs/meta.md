# 제목: 조선궁서체 무료 한글 웹폰트 — 붓글씨 전통을 살린 조선일보 궁서체

- 카테고리: Design > Font
- 태그: 조선궁서체, 무료폰트, 한글폰트, 궁서체, 웹폰트
- 메타디스크립션: 조선일보이 배포하는 무료 한글 폰트 조선궁서체를 실제 페이지 기준으로 검증해 라이선스와 웹폰트 코드까지 정리했습니다.
...
## 검증 기록
- 1차 출처: noonnu.cc 조선궁서체 페이지(font_page/416)
- 확인 시점: 2026-09-10
