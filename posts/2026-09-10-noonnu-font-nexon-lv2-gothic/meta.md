# 제목: 넥슨 Lv.2 고딕 무료 한글 웹폰트 — 한 단계 다듬은 넥슨 본문용 고딕체

- 카테고리: Design > Font
- 태그: 넥슨Lv.2고딕, 무료폰트, 한글폰트, 고딕체, 웹폰트
- 메타디스크립션: 넥슨이 배포하는 무료 한글 폰트 넥슨 Lv.2 고딕를 실제 페이지 기준으로 검증해 라이선스와 웹폰트 코드까지 정리했습니다.
...
## 검증 기록
- 1차 출처: noonnu.cc 넥슨 Lv.2 고딕 페이지(font_page/435)
- 확인 시점: 2026-09-10
