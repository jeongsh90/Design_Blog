# 제목: 함초롬바탕체 무료 한글 웹폰트 — 함초롬바탕체의 결을 담은 무료 한글 서체

- 카테고리: Design > Font
- 태그: 함초롬바탕체, 무료폰트, 한글폰트, 명조체, 웹폰트
- 메타디스크립션: 한글과컴퓨터이 배포하는 무료 한글 폰트 함초롬바탕체를 실제 페이지 기준으로 검증해 라이선스와 웹폰트 코드까지 정리했습니다.
...
## 검증 기록
- 1차 출처: noonnu.cc 함초롬바탕체 페이지(font_page/654)
- 확인 시점: 2026-09-10
