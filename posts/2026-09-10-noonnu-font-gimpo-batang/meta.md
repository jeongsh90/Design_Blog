# 제목: 김포평화바탕 무료 한글 웹폰트 — 본문용으로 다듬은 김포 전용 바탕체

- 카테고리: Design > Font
- 태그: 김포평화바탕, 무료폰트, 한글폰트, 바탕체, 웹폰트
- 메타디스크립션: 김포시이 배포하는 무료 한글 폰트 김포평화바탕를 실제 페이지 기준으로 검증해 라이선스와 웹폰트 코드까지 정리했습니다.
...
## 검증 기록
- 1차 출처: noonnu.cc 김포평화바탕 페이지(font_page/439)
- 확인 시점: 2026-09-10
