# 제목: 유앤피플 고딕체 무료 한글 웹폰트 — 세리프를 살짝 남긴 기업 전용 고딕체

- 카테고리: Design > Font
- 태그: 유앤피플고딕체, 무료폰트, 한글폰트, 고딕체, 웹폰트
- 메타디스크립션: 유앤피플이 배포하는 무료 한글 폰트 유앤피플 고딕체를 실제 페이지 기준으로 검증해 라이선스와 웹폰트 코드까지 정리했습니다.
...
## 검증 기록
- 1차 출처: noonnu.cc 유앤피플 고딕체 페이지(font_page/399)
- 확인 시점: 2026-09-10
