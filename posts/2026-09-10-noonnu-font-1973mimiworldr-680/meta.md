# 제목: 1973미미월드 무료 한글 웹폰트 — 1973미미월드의 결을 담은 무료 한글 서체

- 카테고리: Design > Font
- 태그: 1973미미월드, 무료폰트, 한글폰트, 고딕체, 웹폰트
- 메타디스크립션: 미미월드 X 더폰트그룹이 배포하는 무료 한글 폰트 1973미미월드를 실제 페이지 기준으로 검증해 라이선스와 웹폰트 코드까지 정리했습니다.
...
## 검증 기록
- 1차 출처: noonnu.cc 1973미미월드 페이지(font_page/680)
- 확인 시점: 2026-09-10
