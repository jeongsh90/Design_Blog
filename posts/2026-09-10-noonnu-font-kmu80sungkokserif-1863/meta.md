# 제목: 국민대학교 성곡 세리프 무료 한글 웹폰트 — 국민대학교 성곡 세리프의 결을 담은 무료 한글 서체

- 카테고리: Design > Font
- 태그: 국민대학교성곡세리프, 무료폰트, 한글폰트, 명조체, 웹폰트
- 메타디스크립션: 국민대학교이 배포하는 무료 한글 폰트 국민대학교 성곡 세리프를 실제 페이지 기준으로 검증해 라이선스와 웹폰트 코드까지 정리했습니다.
...
## 검증 기록
- 1차 출처: font_page/1863 (국민대학교 성곡 세리프)
- 확인 시점: 2026-09-10
