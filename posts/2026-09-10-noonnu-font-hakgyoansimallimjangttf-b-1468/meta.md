# 제목: 학교안심 알림장 무료 한글 웹폰트 — 학교안심 알림장의 결을 담은 무료 한글 서체

- 카테고리: Design > Font
- 태그: 학교안심알림장, 무료폰트, 한글폰트, 고딕체, 웹폰트
- 메타디스크립션: Keris(한국교육학술정보원)이 배포하는 무료 한글 폰트 학교안심 알림장를 실제 페이지 기준으로 검증해 라이선스와 웹폰트 코드까지 정리했습니다.
