# 제목: 이사만루 무료 한글 웹폰트 — 야구 로고와 맞춘 게임 브랜드 고딕체

- 카테고리: Design > Font
- 태그: 이사만루, 무료폰트, 한글폰트, 고딕체, 웹폰트
- 메타디스크립션: 공게임즈 X 폰트릭스이 배포하는 무료 한글 폰트 이사만루를 실제 페이지 기준으로 검증해 라이선스와 웹폰트 코드까지 정리했습니다.
...
## 검증 기록
- 1차 출처: noonnu.cc 이사만루 페이지(font_page/463)
- 확인 시점: 2026-09-10
