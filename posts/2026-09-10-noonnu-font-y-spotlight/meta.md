# 제목: Y 너만을 비춤체 무료 한글 웹폰트 — 스포트라이트처럼 또렷한 KT 브랜드 서체

- 카테고리: Design > Font
- 태그: Y너만을비춤체, 무료폰트, 한글폰트, 장식체, 웹폰트
- 메타디스크립션: (주)케이티이 배포하는 무료 한글 폰트 Y 너만을 비춤체를 실제 페이지 기준으로 검증해 라이선스와 웹폰트 코드까지 정리했습니다.
...
## 검증 기록
- 1차 출처: noonnu.cc Y 너만을 비춤체 페이지(font_page/500)
- 확인 시점: 2026-09-10
