# 제목: 쿠키런 무료 한글 웹폰트 — 통통하고 말랑한 게임 브랜드 고딕체

- 카테고리: Design > Font
- 태그: 쿠키런, 무료폰트, 한글폰트, 장식체, 웹폰트
- 메타디스크립션: 데브시스터즈(주)이 배포하는 무료 한글 폰트 쿠키런를 실제 페이지 기준으로 검증해 라이선스와 웹폰트 코드까지 정리했습니다.
...
## 검증 기록
- 1차 출처: noonnu.cc 쿠키런 페이지(font_page/364)
- 확인 시점: 2026-09-10
