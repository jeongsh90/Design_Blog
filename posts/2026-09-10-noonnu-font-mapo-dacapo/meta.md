# 제목: 마포다카포 무료 한글 웹폰트 — 다시 한번, 리듬감 있는 마포 장식체

- 카테고리: Design > Font
- 태그: 마포다카포, 무료폰트, 한글폰트, 장식체, 웹폰트
- 메타디스크립션: 마포구이 배포하는 무료 한글 폰트 마포다카포를 실제 페이지 기준으로 검증해 라이선스와 웹폰트 코드까지 정리했습니다.
...
## 검증 기록
- 1차 출처: noonnu.cc 마포다카포 페이지(font_page/379)
- 확인 시점: 2026-09-10
