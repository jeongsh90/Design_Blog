# 제목: 마포배낭여행 무료 한글 웹폰트 — 여행 가방을 멘 듯 경쾌한 손글씨체

- 카테고리: Design > Font
- 태그: 마포배낭여행, 무료폰트, 한글폰트, 손글씨체, 웹폰트
- 메타디스크립션: 마포구이 배포하는 무료 한글 폰트 마포배낭여행를 실제 페이지 기준으로 검증해 라이선스와 웹폰트 코드까지 정리했습니다.
...
## 검증 기록
- 1차 출처: noonnu.cc 마포배낭여행 페이지(font_page/378)
- 확인 시점: 2026-09-10
