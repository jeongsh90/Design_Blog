# 제목: 만세체 무료 한글 웹폰트 — 힘찬 붓글씨 느낌의 캘리그라피체

- 카테고리: Design > Font
- 태그: 만세체, 무료폰트, 한글폰트, 캘리그라피체, 웹폰트
- 메타디스크립션: 윤디자인M이 배포하는 무료 한글 폰트 만세체를 실제 페이지 기준으로 검증해 라이선스와 웹폰트 코드까지 정리했습니다.
...
## 검증 기록
- 1차 출처: noonnu.cc 만세체 페이지(font_page/339)
- 확인 시점: 2026-09-10
