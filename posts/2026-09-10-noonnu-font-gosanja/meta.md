# 제목: 고산자 무료 한글 웹폰트 — 지도 위에 올린 듯한 국토 정보 서체

- 카테고리: Design > Font
- 태그: 고산자, 무료폰트, 한글폰트, 고전체, 웹폰트
- 메타디스크립션: 국토정보플랫폼 X 산돌이 배포하는 무료 한글 폰트 고산자를 실제 페이지 기준으로 검증해 라이선스와 웹폰트 코드까지 정리했습니다.
...
## 검증 기록
- 1차 출처: noonnu.cc 고산자 페이지(font_page/465)
- 확인 시점: 2026-09-10
