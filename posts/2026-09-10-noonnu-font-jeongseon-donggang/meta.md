# 제목: 정선동강체 무료 한글 웹폰트 — 동강의 흐름을 담은 정선 전용 고딕체

- 카테고리: Design > Font
- 태그: 정선동강체, 무료폰트, 한글폰트, 고딕체, 웹폰트
- 메타디스크립션: 정선군이 배포하는 무료 한글 폰트 정선동강체를 실제 페이지 기준으로 검증해 라이선스와 웹폰트 코드까지 정리했습니다.
...
## 검증 기록
- 1차 출처: noonnu.cc 정선동강체 페이지(font_page/376)
- 확인 시점: 2026-09-10
