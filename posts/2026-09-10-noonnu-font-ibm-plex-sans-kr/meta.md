# 제목: IBM Plex Sans 무료 한글 웹폰트 — IBM이 연 오픈소스 한글 산스 고딕체

- 카테고리: Design > Font
- 태그: IBMPlexSans, 무료폰트, 한글폰트, 고딕체, 웹폰트
- 메타디스크립션: IBM이 배포하는 무료 한글 폰트 IBM Plex Sans를 실제 페이지 기준으로 검증해 라이선스와 웹폰트 코드까지 정리했습니다.
...
## 검증 기록
- 1차 출처: noonnu.cc IBM Plex Sans 페이지(font_page/448)
- 확인 시점: 2026-09-10
