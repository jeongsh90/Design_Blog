# 제목: 조선로고체 무료 한글 웹폰트 — 로고에 맞춘 조선일보 전용 서체

- 카테고리: Design > Font
- 태그: 조선로고체, 무료폰트, 한글폰트, 고딕체, 웹폰트
- 메타디스크립션: 조선일보이 배포하는 무료 한글 폰트 조선로고체를 실제 페이지 기준으로 검증해 라이선스와 웹폰트 코드까지 정리했습니다.
...
## 검증 기록
- 1차 출처: noonnu.cc 조선로고체 페이지(font_page/417)
- 확인 시점: 2026-09-10
